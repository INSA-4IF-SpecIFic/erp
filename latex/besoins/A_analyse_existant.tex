...
\subsection{Description du périmètre : SPIE Sud-Est}
...
L'étude de l'existant que nous venons de porter à terme nous a permis d'identifier certains écarts et dysfonctionnements par rapport à la stratégie de l'entreprise sur différents niveaux.

\subsection{Relation clients et acteurs internes}
Nous avons répéré un manque de procédures pour le retour d'expérience. En particulier :
\begin{itemize}
\item absence d'une procédure de gestion des reclamations venant de la part du client
\item absence d'une procédure d'évaluation de la satisfaction du client
\item absence d'une procédure d'évaluation de la satisfaction des acteurs internes
\item absence d'une procédure d'évaluation des écarts entre les retours clients et les retours acteurs internes
\end{itemize}

\subsection{Organisation des acteurs internes}
En ce qui concerne l'organisation des intervenants, nous retenons qu'il serait intéressant pour SPIE Sud-Est de standardiser les règles générales de gestion des contrats de maintenance, notamment pour :
\begin{itemize}
\item l'affectation des techniciens aux différents projets
\item la rédaction des dossiers client de la part du responsable de contrat
\item la spécification d'indicateurs de performance économique, nécessaires pour le contrôle de gestion 
\item l'identification des risques du projet
\item nouveaux acteurs?
\end{itemize}

\subsection{Technologies}
Les dysfonctionnement que nous venons d'énumerer sont dûs en partie à une inadéquation des technologies à disposition des intervenants. En particulier, nous remarquons :
\begin{itemize}
\item le manque d'un dispositif nomade à disposition des techniciens qui s'occupent des opérations de maintenance
\item ....à compléter
\end{itemize}
