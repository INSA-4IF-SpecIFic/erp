...
\begin{description}
    \item[Retour d'experience client~:] Un procssus ajouter dans le sous processus Solde de l'affaire et du contrat pour les retours client afin de pouvoir \textit{brainstormer} ensuite sur des solutions aux problèmes ayant
    ...
    le bilan du contrat.
    \item[Bilan du contrat~:] Nouveau processus dans le sous processus Solder de l'affaire et du contrat egualement, a fin de prendres d'eventuelles d\'ecisions \`a partir des retours.
