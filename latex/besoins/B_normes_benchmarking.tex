...
\section{Analyse des ERPs}
    ...
    \subsection{Best-practices}
        ...
        \begin{description}
            ...
            \item[Suivi des processus] Des informations de reporting sont fournies aider à faire le suivi des processus de la société et les contrôler. Ces états sont documentés (afin de définir leur sémantique) et peuvent être complétés~;
