...
\begin{tikzpicture}
  ...
  \begin{axis}[
    ...
    ymin=0,
    ymax=40,
	xticklabels={Guillaume \textsc{Abadie},Thierry \textsc{Cantenot},Ahmed \textsc{Kachkach},Marina \textsc{Julien},Martin \textsc{Wetterwald},Valentina \textsc{Zantedeschi}},
	xtick={1,...,6},
